...
<div class="col-sm-12">
   ...
   <form class="installer_form_instant_reload" method="post" action="{{ route('install.store') }}">
      ...
      <div class="form-row">
         <div class="col-sm-6">
            <div class="form-group">
               ...
               <input type="text" name="db_host" class="form-control" required="" placeholder="127.0.0.1" maxlength="20" value="127.0.0.1">
            </div>
         </div>
         <div class="col-sm-6">
            <div class="form-group">
      ...
      <div class="form-group">
         ...
         <input type="text" name="db_name" class="form-control" required="" placeholder="whats" value="whats">
      </div>
      <div class="form-group">
         <label>{{ __('Database Username') }}</label>
         <input type="text" name="db_user" class="form-control" required="" placeholder="root" value="root">
      </div>
      <div class="form-group">
