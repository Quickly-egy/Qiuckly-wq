...
class InstallerController extends Controller
{
    ...
    public function store(Request $request)
    {
       ...
       // Clear config cache and reload database configuration
       \Artisan::call('config:clear');
       
       // Purge the current database connection to force a new connection
       \DB::purge('mysql');
       ...
       \Config::set('database.connections.mysql.password', $request->db_pass);
