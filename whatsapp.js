         ...
         try{
            ...
            if (message.key.fromMe == false && messages.type == 'notify') {
                ...
                if (message != '' && isGroup == false) {
                    ...
                    // Comment out undefined function call
...
const getChatList = (sessionId, isGroup = false) => {
    ...
    // Since store is not available, return empty array for now
    // This function would need to be implemented differently without makeInMemoryStore
    return []
}
...
const cleanup = () => {
    ...
    // Remove store.writeToFile calls since store is no longer available
    sessions.forEach((session, sessionId) => {
        // Store functionality is no longer available
        // if (!session.isLegacy) {
